...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = UTOS(src1) >> imm);
  INSTPAT("??????? ????? ????? 010 ????? 00100 11", slti   , I, R(dest) = UTOS(src1) < UTOS(imm) ? 1 : 0);
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , R, R(dest) = UTOS(src1) >> src2);
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", sr1    , R, R(dest) = src1 >> src2);
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(dest) = src1 * src2);
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(dest) = (SEXT(src1, 32) * SEXT(src2, 32)) >> 32);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(dest) = UTOS(src1) / UTOS(src2));
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(dest) = src1 / src2);
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(dest) = UTOS(src1) % UTOS(src2));
